...
const navigationByRole: Record<Role, NavItem[]> = {
  buyer: [
    ...
    { label: "Notificaciones", href: "/buyer/notifications", icon: Bell },
    { label: "Mensajes", href: "/buyer/chat", icon: MessageCircle },
  ...
  seller: [
    ...
    { label: "Notificaciones", href: "/seller/notifications", icon: Bell },
    { label: "Mensajes", href: "/seller/chat", icon: MessageCircle },
  ...
  admin: [
    ...
    { label: "Marcas", href: "/admin/brands", icon: Award },
    { label: "Regiones", href: "/admin/regions", icon: Globe },
    ...
    { label: "Retiros", href: "/admin/withdrawals", icon: ArrowDownToLine },
    { label: "Vemper Games", href: "/admin/vemper", icon: Gamepad2 },
