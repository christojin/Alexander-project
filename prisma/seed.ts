...
async function main() {
  ...
  const brandsData = [
    ...
    { name: "HBO Max", slug: "hbo-max", displayOrder: 11 },
    { name: "YouTube Premium", slug: "youtube-premium", displayOrder: 12 },
    { name: "Apple", slug: "apple", displayOrder: 13 },
  ...
  await Promise.all([
    prisma.banner.create({
      data: {
        title: "Gift Cards al Mejor Precio",
    ...
    prisma.banner.create({
      data: {
        title: "Streaming Premium desde $2.99",
        imageUrl: "/images/banners/banner-streaming.jpg",
    ...
    prisma.banner.create({
      data: {
        title: "Top-Up Gaming - Entrega Rápida",
